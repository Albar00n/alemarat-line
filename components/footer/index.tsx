...
const Footer = (props:any) => {
    ...
    return (
        <div>
            {/* <CtaSection/> */}
            <footer className="footer-section pt-220" style={{ backgroundImage: `url('/images/footer.png')` }}>
                    ...
                    <div className="container">
                        <div className="bottom-inner">
                            <div className="social-icons">
                                <Link onClick={ClickHandler} href="/"><i className="fa fa-twitter"></i></Link>
                                <Link onClick={ClickHandler} href="/"><i className="fa fa-facebook"></i></Link>
                                <Link onClick={ClickHandler} href="/"><i className="fa fa-instagram"></i></Link>
                                <Link onClick={ClickHandler} href="/"><i className="fa fa-pinterest"></i></Link>
                            </div>
                            <div className="copyright">
                                <p>© Copyright 2024 ALEMARAT LINE by <Link onClick={ClickHandler} href="https://qurashi.xyz">QURASHI</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
